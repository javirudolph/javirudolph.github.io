...
-   This blog post (hi! :wave:) [source_code](https://github.com/javirudolph/javirudolph.github.io/blob/main/posts/2025-06-19-computational-literacy/index.qmd)
...
The first iteration of code captured all the general website text, but it didn't focus on computational literacy content. Then I realized, I was looking at the general Smathers Library website, and I should probably focus on [ARCS](https://arcs.uflib.ufl.edu/) or the services page. So, I went with that one. 
