...
3.  Create a new branch called `yourname-branch` in the [github-practice](https://github.com/javirudolph/github-practice) repo.
<!-- ![Create a branch](branch_screenshot.png) -->
![Create a branch2](branch_screenshot_2.png)
4.  Make a change in this branch and save the change as a commit (Hint: green button that says *Commit changes...*)
![Create a change in the branch](branch_screenshot3.png)
When you save or commit your changes, it is recommended that you add a little message to say what you did.
![Commit message](branch_screenshot4.png) 

5.  **Open pull request** to suggest your changes be included into the main branch. This is basically sending me a message - "Hey Javi, I made some changes, can you ***pull*** them from my branch?". 
![pull request](pull_request.png)
![message request](pull_request2.png)
...
![merge screenshot](merge_screenshot.png)
# You did it!
